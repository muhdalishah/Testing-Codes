...
$querys  = " INSERT INTO `courses` (`ctitle`, `cdetail`, `cduration`, `cstart`, `cend`, `userid`) 
VALUES ( '$title', '$detail', '$duration', '$start', '$end', '$userid');";
...
<form action="course_add.php" method="POST">
  <div class="mb-3">
    ...
    <input type="text" name="ctitle" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    </div>
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Course Detail </label>
    <textarea  cols="6" rows="6" type="text" name="cdetail" class="form-control"></textarea>
  </div>

  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Course Duration </label>
    <input type="number" name="cduration"  class="form-control"/>
  </div>

  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">Start </label>
    <input type="date" class="form-control" name="cstart"/>
  </div>
  
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label">End </label>
    <input type="date" class="form-control" name="cend"/>
  </div>
